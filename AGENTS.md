...
- **Credit and disclose; don't compete.** matchaflavoured.wiki is the players' community wiki, and our
  logo, skin setup and most Lua modules come from it (CC BY-NC-SA 4.0). Keep the credit on the About page
  (update it if more is borrowed), and keep saying on the site that the articles are "generated by a
