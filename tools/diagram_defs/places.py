...
from diagrams import (SMALL, TEXT, VANILLA_DATA, PACK_DATA, SRC, Flow, Svg, data, diagram, legend, mcfunction, need, pack_json,
                      text_width)
...
def warding_stone():
    from diagram_defs.areas import rings, scale_bar
