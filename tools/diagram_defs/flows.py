"""Flow charts of the pack's chains: progression, the Hell-Bound Book and the sacred texts. Node
contents come from the recipes, loot tables, trades and functions, and a missing recipe or changed
function raises, so CI notices."""
import re
